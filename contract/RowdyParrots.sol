...
contract RowdyParrots is ERC721Enumerable, Ownable {
   ...
   string public baseTokenURI;
    ...
    event RowdyParrotsMinted(uint256 indexed count, address from);
    ...
    */
    ...
    constructor() ERC721("RowdyParrots", "RP") {
        //setBaseURI(baseURI);
    }
    ...
    function preSaleMint(uint256 _mintCount) public payable onlyWhitelisted {
        ...
        emit RowdyParrotsMinted(_mintCount, msg.sender);
